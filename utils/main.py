...
def main():
    ...
    end_members_extracted, decoded_data_reconstructed, abundances_maps_reconstructed\
        = running_experiment_custom_reduce(hypercube_data_patches, parameters,
                                           enhancement_initializer_mean,
