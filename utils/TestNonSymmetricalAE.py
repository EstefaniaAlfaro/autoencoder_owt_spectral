...
from Runing_experiment_NSAE_SU import *

data_path = '../data/JasperRidge.mat'
...
number_patches = 250
batch_size_model = 15
# configuration_file = 'configuration_file_blind_su'
configuration_file = 'configuration_file_DCNN_SU'


def non_symmetrical_autoencoder_test():
    ...
    abundances_maps_reconstructed_append, end_members_extracted_append = \
        experiment_non_su(hypercube_data_patches, hypercube_data, parameters,
                                                            image_width, image_height, abundances_ground_truth,
                                                            ground_truth_end_members)
    print('---- Program finish :)----')


non_symmetrical_autoencoder_test()